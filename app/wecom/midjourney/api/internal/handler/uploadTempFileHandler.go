...
func uploadTempFileHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UploadTempFileReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewUploadTempFileLogic(r.Context(), svcCtx)
		resp, err := l.UploadTempFile(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
